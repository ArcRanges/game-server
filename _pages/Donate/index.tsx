...
const PAYPAL_LINK_PH =
  "https://www.paypal.com/donate/?business=BD73SS58WSTCE&no_recurring=0&item_name=Gameserver+community+donation&currency_code=PHP";
...
export default function index() {
  return (
    <div className="relative">
      ...
      <Container>
        <div className="mx-auto text-center mb-10 pb-10 border-b">
          <h2 className="font-bold text-white">Donate (International)</h2>
        ...
        <div className="mx-auto text-center">
          <h2 className="font-bold text-white">Donate (Philippines)</h2>
          <p className="text-gray-200 mb-3">We appreciate your support</p>

          <div className="flex flex-col items-center">
            <div style={{ height: 150, width: 150, marginBottom: 20 }}>
              <Image
                src="/img/donate-qr-ph.png"
                height="150px"
                width="150px"
                layout="responsive"
              />
            ...
            >
              <div className="flex justify-center">
                <input type="hidden" name="business" value="BD73SS58WSTCE" />
                <input type="hidden" name="no_recurring" value="0" />
                <input
                  type="hidden"
                  name="item_name"
